 ...
 * <ul>
 *   <li>{@link org.summer.dsl.model.richstring.impl.ElseStartImpl#getIfConditionStart <em>If Condition Start</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElseStartImpl extends LinePartImpl implements ElseStart {
	...
	protected EClass eStaticClass() {
		return RichstringPackage.Literals.ELSE_START;
	}
		...
		if (ifConditionStart != null && ifConditionStart.eIsProxy()) {
			...
			if (ifConditionStart != oldIfConditionStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RichstringPackage.ELSE_START__IF_CONDITION_START, oldIfConditionStart, ifConditionStart));
			}
		}
	...
	public NotificationChain basicSetIfConditionStart(IfConditionStart newIfConditionStart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RichstringPackage.ELSE_START__IF_CONDITION_START, oldIfConditionStart, newIfConditionStart);
	...
	public void setIfConditionStart(IfConditionStart newIfConditionStart) {
		if (newIfConditionStart != ifConditionStart) {
			...
			if (ifConditionStart != null)
				msgs = ((InternalEObject)ifConditionStart).eInverseRemove(this, RichstringPackage.IF_CONDITION_START__ELSE_START, IfConditionStart.class, msgs);
			if (newIfConditionStart != null)
				msgs = ((InternalEObject)newIfConditionStart).eInverseAdd(this, RichstringPackage.IF_CONDITION_START__ELSE_START, IfConditionStart.class, msgs);
			msgs = basicSetIfConditionStart(newIfConditionStart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RichstringPackage.ELSE_START__IF_CONDITION_START, newIfConditionStart, newIfConditionStart));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RichstringPackage.ELSE_START__IF_CONDITION_START:
				if (ifConditionStart != null)
					msgs = ((InternalEObject)ifConditionStart).eInverseRemove(this, RichstringPackage.IF_CONDITION_START__ELSE_START, IfConditionStart.class, msgs);
