...
public class RichstringSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RichstringPackage.PROCESSED_RICH_STRING: {
			...
			case RichstringPackage.LINE: {
				Line line = (Line)theEObject;
				T result = caseLine(line);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RichstringPackage.LINE_PART: {
				LinePart linePart = (LinePart)theEObject;
				T result = caseLinePart(linePart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RichstringPackage.LITERAL: {
			...
			case RichstringPackage.LINE_BREAK: {
			...
			case RichstringPackage.FOR_LOOP_START: {
			...
			case RichstringPackage.FOR_LOOP_END: {
			...
			case RichstringPackage.PRINTED_EXPRESSION: {
			...
			case RichstringPackage.IF_CONDITION_START: {
			...
			case RichstringPackage.ELSE_IF_CONDITION: {
			...
			case RichstringPackage.ELSE_START: {
