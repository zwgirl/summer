 ...
 * @generated
 */
public class XannotationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case XannotationPackage.XANNOTATION: {
			...
			case XannotationPackage.XANNOTATION_ELEMENT_VALUE_PAIR: {
