 ...
 * <ul>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCallImpl#getMemberCallTarget <em>Member Call Target</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCallImpl#getMemberCallArguments <em>Member Call Arguments</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCallImpl#isExplicitOperationCall <em>Explicit Operation Call</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCallImpl#isExplicitStatic <em>Explicit Static</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCallImpl#isNullSafe <em>Null Safe</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCallImpl#isTypeLiteral <em>Type Literal</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCallImpl#isStaticWithDeclaringType <em>Static With Declaring Type</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCallImpl#isPackageFragment <em>Package Fragment</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCallImpl#isIndexedOperation <em>Indexed Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated NOT
...
public class XMemberFeatureCallImpl extends XAbstractFeatureCallImplCustom implements XMemberFeatureCall {
	...
	public void setIndexedOperation(boolean newIndexedOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL__INDEXED_OPERATION, oldIndexedOperation, indexedOperation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XbasePackage.XMEMBER_FEATURE_CALL__INDEXED_OPERATION:
