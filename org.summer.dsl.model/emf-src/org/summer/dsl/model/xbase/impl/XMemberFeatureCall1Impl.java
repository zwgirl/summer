 ...
 * <ul>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCall1Impl#getMemberCallTarget <em>Member Call Target</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCall1Impl#getMemberCallArguments <em>Member Call Arguments</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCall1Impl#isExplicitOperationCall <em>Explicit Operation Call</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCall1Impl#isExplicitStatic <em>Explicit Static</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCall1Impl#isNullSafe <em>Null Safe</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCall1Impl#isTypeLiteral <em>Type Literal</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCall1Impl#isStaticWithDeclaringType <em>Static With Declaring Type</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCall1Impl#isPackageFragment <em>Package Fragment</em>}</li>
 *   <li>{@link org.summer.dsl.model.xbase.impl.XMemberFeatureCall1Impl#isIndexedOperation <em>Indexed Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated NOT
 */
public class XMemberFeatureCall1Impl extends XAbstractFeatureCallImplCustom implements XMemberFeatureCall1 {
	/**
	 ...
	 * @generated
	 */
	protected XMemberFeatureCall1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return XbasePackage.Literals.XMEMBER_FEATURE_CALL1;
	}
	...
	public NotificationChain basicSetMemberCallTarget(XExpression newMemberCallTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL1__MEMBER_CALL_TARGET, oldMemberCallTarget, newMemberCallTarget);
	...
	public void setMemberCallTarget(XExpression newMemberCallTarget) {
		if (newMemberCallTarget != memberCallTarget) {
			...
			if (memberCallTarget != null)
				msgs = ((InternalEObject)memberCallTarget).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XbasePackage.XMEMBER_FEATURE_CALL1__MEMBER_CALL_TARGET, null, msgs);
			if (newMemberCallTarget != null)
				msgs = ((InternalEObject)newMemberCallTarget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XbasePackage.XMEMBER_FEATURE_CALL1__MEMBER_CALL_TARGET, null, msgs);
			msgs = basicSetMemberCallTarget(newMemberCallTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL1__MEMBER_CALL_TARGET, newMemberCallTarget, newMemberCallTarget));
	}
	...
	public EList<XExpression> getMemberCallArguments() {
		if (memberCallArguments == null) {
			memberCallArguments = new EObjectContainmentEList<XExpression>(XExpression.class, this, XbasePackage.XMEMBER_FEATURE_CALL1__MEMBER_CALL_ARGUMENTS);
		}
	...
	public void setExplicitOperationCall(boolean newExplicitOperationCall) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL1__EXPLICIT_OPERATION_CALL, oldExplicitOperationCall, explicitOperationCall));
	}
	...
	public void setExplicitStatic(boolean newExplicitStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL1__EXPLICIT_STATIC, oldExplicitStatic, explicitStatic));
	}
	...
	public void setNullSafe(boolean newNullSafe) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL1__NULL_SAFE, oldNullSafe, nullSafe));
	}
	...
	public void setTypeLiteral(boolean newTypeLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL1__TYPE_LITERAL, oldTypeLiteral, typeLiteral));
	}
	...
	public void setStaticWithDeclaringType(boolean newStaticWithDeclaringType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL1__STATIC_WITH_DECLARING_TYPE, oldStaticWithDeclaringType, staticWithDeclaringType));
	}
	...
	public void setPackageFragment(boolean newPackageFragment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL1__PACKAGE_FRAGMENT, oldPackageFragment, packageFragment));
	}
	...
	public void setIndexedOperation(boolean newIndexedOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XbasePackage.XMEMBER_FEATURE_CALL1__INDEXED_OPERATION, oldIndexedOperation, indexedOperation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XbasePackage.XMEMBER_FEATURE_CALL1__MEMBER_CALL_TARGET:
				return basicSetMemberCallTarget(null, msgs);
			case XbasePackage.XMEMBER_FEATURE_CALL1__MEMBER_CALL_ARGUMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XbasePackage.XMEMBER_FEATURE_CALL1__EXPLICIT_OPERATION_CALL:
				return isExplicitOperationCall();
			case XbasePackage.XMEMBER_FEATURE_CALL1__EXPLICIT_STATIC:
				return isExplicitStatic();
			case XbasePackage.XMEMBER_FEATURE_CALL1__NULL_SAFE:
				return isNullSafe();
			case XbasePackage.XMEMBER_FEATURE_CALL1__TYPE_LITERAL:
				return isTypeLiteral();
			case XbasePackage.XMEMBER_FEATURE_CALL1__STATIC_WITH_DECLARING_TYPE:
				return isStaticWithDeclaringType();
			case XbasePackage.XMEMBER_FEATURE_CALL1__PACKAGE_FRAGMENT:
				return isPackageFragment();
			case XbasePackage.XMEMBER_FEATURE_CALL1__INDEXED_OPERATION:
