...
//		else if (Modifier.isProtected(clazz.getModifiers()))  //cym comment
//			result.setVisibility(JvmVisibility.PROTECTED);
	...
	protected void setVisibility(org.summer.dsl.model.types.JvmMember result, int modifiers) {
		if (Modifier.isPrivate(modifiers))
			result.setVisibility(JvmVisibility.PRIVATE);
//		else if (Modifier.isProtected(modifiers))   // cym comment
//			result.setVisibility(JvmVisibility.PROTECTED); // cym comment
		else //if (Modifier.isPublic(modifiers))
			result.setVisibility(JvmVisibility.PUBLIC);
//		else // cym comment
//			result.setVisibility(JvmVisibility.DEFAULT);// cym comment
	}
