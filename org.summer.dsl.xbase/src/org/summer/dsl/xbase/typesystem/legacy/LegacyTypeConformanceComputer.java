...
import org.summer.dsl.model.types.util.TypeConformanceResult.Kind;
...
import org.summer.dsl.xbase.typing.XbaseTypeConformanceComputer;
...
public class LegacyTypeConformanceComputer extends XbaseTypeConformanceComputer {
	...
	public TypeConformanceResult isConformant(JvmTypeReference left, JvmTypeReference right, TypeConformanceComputationArgument flags) {
		...
		org.summer.dsl.xbase.typesystem.conformance.TypeConformanceResult result = leftLightweight.internalIsAssignableFrom(rightLightweight, new org.summer.dsl.xbase.typesystem.conformance.TypeConformanceComputationArgument(
