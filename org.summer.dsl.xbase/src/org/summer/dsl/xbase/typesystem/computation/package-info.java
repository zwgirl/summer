 ...
 * <ol>
 *	<li>{@link org.summer.dsl.xbase.typesystem.computation.ITypeComputer ITypeComputer} -
 ...
 *    {@link org.summer.dsl.xbase.typesystem.computation.XbaseTypeComputer default implementation}.  
 *	</li>
 *  <li>{@link org.summer.dsl.xbase.typesystem.computation.ITypeComputationState ITypeComputationState} -
 ...
 *	</li>
 *  <li>{@link org.summer.dsl.xbase.typesystem.computation.ITypeExpectation ITypeExpectation} -
 *    One of the currently expected types. This can be evaluated in order to compute a type which
 *    depends on the current context, e.g. a {@link org.summer.dsl.xbase.XStringLiteral string}
 ...
 *	</li>
 *  <li>{@link org.summer.dsl.xbase.typesystem.computation.ITypeComputationResult ITypeComputationResult} -
 ...
 * <ol>
 *	<li>{@link org.summer.dsl.xbase.typesystem.computation.SynonymTypesProvider SynonymTypesProvider} -
 ...
 *    conversion.
 *	</li>
 *  <li>{@link org.summer.dsl.xbase.typesystem.computation.NumberLiterals NumberLiterals} -
 *    Type computation for {@link org.summer.dsl.xbase.XNumberLiteral}, e.g. which sort of concrete
 *    syntax may yield a {@link com.ibm.icu.math.BigDecimal BigDecimal} or {@link java.math.BigInteger BigInteger}.
 *	</li>
 *  <li>{@link org.summer.dsl.xbase.typesystem.computation.ClosureTypeComputer ClosureTypeComputer} -
 *    The type computation of {@link org.summer.dsl.xbase.XClosure lambda expressions} is implemented in
 *    this utility.
 *	</li>
 * </ol>
 * 
 ...
 * <ol>
 *	<li>{@link org.summer.dsl.xbase.typesystem.computation.ILinkingCandidate Linking candidates} -
 ...
 *	</li>
 *  <li>{@link org.summer.dsl.xbase.typesystem.computation.ITypeAssigner ITypeAssigner} -
 *    The type assigner allows to bulk-assign local variables that are defined on the same level. Good
 *    use cases include {@link org.summer.dsl.model.types.JvmFormalParameter parameters} of lambdas or methods.
 *	</li>
 *  <li>{@link org.summer.dsl.xbase.typesystem.computation.ClosureTypeComputer ClosureTypeComputer} -
 *    The type computation of {@link org.summer.dsl.xbase.XClosure lambda expressions} is implemented in
 *    this utility.
