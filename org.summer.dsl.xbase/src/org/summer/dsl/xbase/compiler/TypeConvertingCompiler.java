...
import org.summer.dsl.xbase.typing.Closures;
...
//		JvmTypeReference resolvedLeft = closures.getResolvedExpectedType(expectedType, functionType);
	...
	//TODO externalize whole conversion strategy and use org.summer.dsl.xbase.typing.SynonymTypesProvider.isList(JvmTypeReference)
