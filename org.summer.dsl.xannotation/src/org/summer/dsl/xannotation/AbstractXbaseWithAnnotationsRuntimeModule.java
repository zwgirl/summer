...
/**
 * Manual modifications go to {org.summer.dsl.xannotation.XbaseWithAnnotationsRuntimeModule}
 */
...
public abstract class AbstractXbaseWithAnnotationsRuntimeModule extends DefaultRuntimeModule {
	 ...
	 protected Properties properties = null;
		...
		public void configure(Binder binder) {
			properties = tryBindProperties(binder, "org/summer/dsl/xannotation/XbaseWithAnnotations.properties");
			super.configure(binder);
		}
		
		public void configureLanguageName(Binder binder) {
			binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.summer.dsl.xannotation.XbaseWithAnnotations");
		}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.summer.dsl.xannotation.services.XbaseWithAnnotationsGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.summer.dsl.xannotation.serializer.XbaseWithAnnotationsSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.summer.dsl.xannotation.serializer.XbaseWithAnnotationsSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.summer.dsl.xannotation.parser.antlr.XbaseWithAnnotationsParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.summer.dsl.xannotation.parser.antlr.XbaseWithAnnotationsAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.summer.dsl.xannotation.parser.antlr.internal.InternalXbaseWithAnnotationsLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.summer.dsl.xannotation.parser.antlr.internal.InternalXbaseWithAnnotationsLexer> provideInternalXbaseWithAnnotationsLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.summer.dsl.xannotation.parser.antlr.internal.InternalXbaseWithAnnotationsLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.summer.dsl.xannotation.parser.antlr.internal.InternalXbaseWithAnnotationsLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.summer.dsl.xannotation.validation.XbaseWithAnnotationsJavaValidator> bindXbaseWithAnnotationsJavaValidator() {
		return org.summer.dsl.xannotation.validation.XbaseWithAnnotationsJavaValidator.class;
	}
	...
	public void configureIScopeProviderDelegate(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.scoping.IScopeProvider.class).annotatedWith(Names.named(org.eclipse.xtext.scoping.impl.AbstractDeclarativeScopeProvider.NAMED_DELEGATE)).to(org.summer.dsl.xbase.scoping.XbaseImportedNamespaceScopeProvider.class);
	}
	...
	// contributed by org.summer.dsl.generator.xbase.XbaseGeneratorFragment
	...
	public Class<? extends org.eclipse.xtext.resource.ILocationInFileProvider> bindILocationInFileProvider() {
		return org.summer.dsl.xbase.resource.XbaseLocationInFileProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.summer.dsl.xannotation.formatting.XbaseWithAnnotationsFormatter.class;
	}
