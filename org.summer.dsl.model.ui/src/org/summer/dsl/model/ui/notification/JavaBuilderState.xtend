 ...
 *******************************************************************************/
package org.summer.dsl.model.ui.notification
...
class JavaBuilderState {
	...
	static def getLastBuiltState(IJavaElement it) {
		...
		javaProject.project.getLastBuiltState
	}

	static def getLastBuiltState(IProject it) {
		new org.summer.dsl.model.ui.notification.JavaBuilderState(it,
	...
	def dispatch getQualifiedTypeNames(IPackageFragment it) {
		...
		val srcPathSegmentCount = getPackageFragmentRoot.resource.projectRelativePath.segmentCount
	...
	def dispatch getQualifiedTypeNames(ICompilationUnit it) {
		getTypeLocator.getQualifiedTypeNames(getPackageName, getSimplePrimaryTypeName)
	}

	private def IPackageFragmentRoot getPackageFragmentRoot(IJavaElement it) {
		switch parent : parent {
			IPackageFragmentRoot: parent
			default: parent.getPackageFragmentRoot
		}
	}
