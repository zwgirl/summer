...
import org.summer.dsl.model.ui.notification.DeltaConverter
...
class BuilderDeltaConverter extends DeltaConverter {
	...
	override createStructureChangeDelta(IType type, IResourceDescription oldDescription,
		...
		return new org.summer.dsl.builder.impl.javasupport.UnconfirmedStructuralChangesDelta(type, oldDescription, newDescription)
	}
