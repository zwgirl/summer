...
import org.summer.xaml.core.scoping.XbaseWithAnnotationsBatchScopeProvider1;

import com.google.inject.Binder;
import com.google.inject.name.Names;

/**
 * Manual modifications go to {org.summer.xaml.core.XAMLRuntimeModule}
 */
...
public abstract class AbstractXAMLRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/summer/xaml/core/XAML.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.summer.xaml.core.XAML");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.summer.xaml.core.services.XAMLGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.summer.xaml.core.serializer.XAMLSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.summer.xaml.core.serializer.XAMLSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.summer.xaml.core.parser.antlr.XAMLParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.summer.xaml.core.parser.antlr.XAMLAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.summer.xaml.core.parser.antlr.internal.InternalXAMLLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.summer.xaml.core.parser.antlr.internal.InternalXAMLLexer> provideInternalXAMLLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.summer.xaml.core.parser.antlr.internal.InternalXAMLLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.summer.xaml.core.parser.antlr.internal.InternalXAMLLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.summer.xaml.core.validation.XAMLValidator> bindXAMLValidator() {
		return org.summer.xaml.core.validation.XAMLValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.summer.xaml.core.formatting.XAMLFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.scoping.IScopeProvider> bindIScopeProvider() {
		return org.summer.xaml.core.scoping.XAMLScopingProvider.class;
	}
...
//		return org.summer.dsl.xannotation.typesystem.XbaseWithAnnotationsBatchScopeProvider.class;
		return XbaseWithAnnotationsBatchScopeProvider1.class;
	}
	...
	// contributed by org.eclipse.xtext.generator.xbase.XbaseGeneratorFragment
	public Class<? extends org.summer.dsl.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.summer.xaml.core.jvmmodel.XAMLJvmModelInferrer.class;
	}
