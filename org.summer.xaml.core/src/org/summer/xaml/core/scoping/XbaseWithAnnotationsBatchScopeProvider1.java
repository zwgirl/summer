...
public class XbaseWithAnnotationsBatchScopeProvider1 extends XbaseWithAnnotationsBatchScopeProvider{
	@Override
	public IScope getScope(EObject context, EReference reference) {
		...
		}else if(context instanceof AttributeElement && (reference==XAMLPackage.Literals.ATTRIBUTE_ELEMENT__CLOSE_ATTRIBUTE)){
			AttributeElement attributeElement = (AttributeElement) context;
			if(attributeElement.getClose() instanceof JvmGenericType){
				JvmGenericType genericType = (JvmGenericType) attributeElement.getClose(); 
