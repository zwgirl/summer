...
(
    ...
    { 
        $current = $this_ObjectElement_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_AttributeElement_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
(
    ...
    { 
        $current = $this_GeneralProperty_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_AttachProperty_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleAttachProperty returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAttachPropertyRule()); }
	 iv_ruleAttachProperty=ruleAttachProperty 
	 { $current=$iv_ruleAttachProperty.current; } 
	 EOF 
;

// Rule AttachProperty
ruleAttachProperty returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='(' 
...
entryRuleMarkupExtenson returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMarkupExtensonRule()); }
	 iv_ruleMarkupExtenson=ruleMarkupExtenson 
	 { $current=$iv_ruleMarkupExtenson.current; } 
	 EOF 
;

// Rule MarkupExtenson
ruleMarkupExtenson returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleGeneralProperty returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getGeneralPropertyRule()); }
	 iv_ruleGeneralProperty=ruleGeneralProperty 
	 { $current=$iv_ruleGeneralProperty.current; } 
	 EOF 
;

// Rule GeneralProperty
ruleGeneralProperty returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
    ...
    { 
        $current = $this_MarkupExtenson_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
