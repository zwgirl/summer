...
public class CodetemplatesStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.summer.dsl.ui.codetemplates.CodetemplatesRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/xtext/codetemplate/Codetemplates")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/xtext/codetemplate/Codetemplates", org.summer.dsl.ui.codetemplates.templates.TemplatesPackage.eINSTANCE);
	}
