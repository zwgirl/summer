...
// Rule Type
 ruleType :
	ruleXAnnotation* (
		'export'? ruleCommonModifier* 'class' ruleValidID (
		...
		'export'? ruleCommonModifier* 'interface' ruleValidID (
			'<' ruleJvmTypeParameter (
				',' ruleJvmTypeParameter
			)* '>'
		)? (
...
// Rule Member
 ruleMember :
	ruleXAnnotation* (
		...
		ruleCommonModifier* ruleXClosure |
		ruleCommonModifier* 'constructor' (
			'<' ruleJvmTypeParameter (
				',' ruleJvmTypeParameter
			)* '>'
		)? '(' (
