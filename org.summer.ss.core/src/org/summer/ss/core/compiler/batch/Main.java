...
import org.summer.ss.core.SsInjectorSingleton;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Injector injector = SsInjectorSingleton.INJECTOR;
		SsBatchCompiler xtendBatchCompiler = injector.getInstance(SsBatchCompiler.class);
