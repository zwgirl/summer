package org.summer.ss.core.compiler.batch;
...
import org.summer.dsl.model.types.descriptions.IStubGenerator;
...
import org.summer.dsl.xbase.compiler.IGeneratorConfigProvider;
...
public class SsBatchCompiler {
	...
	private final static Logger log = Logger.getLogger(SsBatchCompiler.class.getName());
