...
import org.summer.dsl.xbase.formatting.NodeModelAccess
import org.summer.dsl.xbase.formatting.FormattingDataFactory
import org.summer.dsl.xbase.formatting.FormattableDocument
import org.summer.dsl.xbase.formatting.NewLineData
import org.summer.dsl.xbase.formatting.WhitespaceData
...
//		println("-------------------------")
	...
	def protected dispatch void fmt((EObject, FormattableDocument)=>void formatter, FormattableDocument doc, RichStringIf expr) {
		...
		doc += expr.nodeForFeature(SsPackage.Literals.RICH_STRING_ELSE_IF__IF).append[noSpace]
