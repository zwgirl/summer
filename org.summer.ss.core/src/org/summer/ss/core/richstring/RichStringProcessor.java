...
import org.summer.ss.core.richstring.util.ProcessedRichStringSwitch;
...
import org.summer.dsl.model.ss.util.SsSwitch;
...
public class RichStringProcessor {
	...
	public static class ProcessedRichStringBuilder extends SsSwitch<Boolean> {
