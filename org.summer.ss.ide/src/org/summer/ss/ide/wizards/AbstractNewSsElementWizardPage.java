 ...
 */
public abstract class AbstractNewSsElementWizardPage extends NewTypeWizardPage {
	...
	public AbstractNewSsElementWizardPage(int typeKind, String title) {
		...
		IRunnableWithProgress op = new WorkspaceModifyOperation() {
			...
			protected void execute(IProgressMonitor monitor) throws CoreException, InvocationTargetException,
				...
				try {
					...
					IFile xtendFile = ((IFolder) res).getFile(getTypeName() + ".ss"); //$NON-NLS-1$
	...
	protected IStatus typeNameChanged() {
		...
		if (packageFragment != null) {
			...
			if (resource instanceof IFolder) {
				...
				if (folder.getFile(getTypeName() + ".ss").exists()) { //$NON-NLS-1$
