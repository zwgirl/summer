 ...
 */
public class SsContainerWizardPage extends NewElementWizardPage implements IClasspathContainerPage {

	private IClasspathEntry containerEntry;

	public SsContainerWizardPage() {
		...
		this.containerEntry = JavaCore.newContainerEntry(SsContainerInitializer.XTEND_LIBRARY_PATH);
	}
