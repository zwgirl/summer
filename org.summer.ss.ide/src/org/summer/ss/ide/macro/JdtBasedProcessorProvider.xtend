 ...
 *******************************************************************************/
package org.summer.ss.ide.macro
		...
		for (entry : resolvedClasspath) {
			...
			switch entry.entryKind {
				...
				case IClasspathEntry.CPE_PROJECT: {
					...
					val IResource project = projectToUse.getWorkspaceRoot.findMember(path)
				...
				case IClasspathEntry.CPE_LIBRARY: {
					...
					val IResource library = projectToUse.getWorkspaceRoot.findMember(path)
					url = if (library != null) {
