...
import org.summer.ss.ide.formatting.FormatterFactory.FormattingUnitOfWork;
...
public class SsFormatterPreview implements Observer {
	
	private final static Logger log = Logger.getLogger(SsFormatterPreview.class);
	...
	public SsFormatterPreview forEmbeddedEditor(EmbeddedEditor editorHandle) {
	...
	public SsFormatterPreview withPreviewContent(String previewContent) {
	...
	private void checkEditorHandleIsSet() {
		if (editorHandle == null) {
			throw new IllegalStateException(
					"This preview should be bind to an EmbeddedEditor, call SsFormatterPreview#forEmbeddedEditor(EmbeddedEditor) first");
		}
	}
